  ...
  return (
    <div className="space-y-6">
          ...
          <Form className="space-y-4">
            ...
            <div className="space-y-1.5 text-left">
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={() => navigate('/auth/forgot-password', { state: { backgroundLocation: location.state?.backgroundLocation || location } })}
      ...
      <div className="space-y-3">
        <button
          type="button"
          className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-800 hover:bg-gray-50 transition-all duration-200 flex items-center justify-center gap-2 hover:shadow-md active:scale-[0.98]"
        >
      ...
      <div className="text-center text-sm text-gray-600">
        ...
        <button
          type="button"
          onClick={() => navigate('/auth/register', { state: { backgroundLocation: location.state?.backgroundLocation || location } })}
