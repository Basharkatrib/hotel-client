  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <button
          type="button"
          className="cursor-pointer w-full rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-card px-4 py-2.5 text-sm font-bold text-gray-800 dark:text-white hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-300 flex items-center justify-center gap-2 hover:shadow-md active:scale-[0.98]"
        >
