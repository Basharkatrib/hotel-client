        ...
        <div className="flex flex-col lg:flex-row gap-12 mb-[80px]">
          ...
          <div className="flex flex-col gap-8 w-full lg:w-1/3 items-start text-left">
            ...
            <div className="flex flex-col gap-3 w-full">
              <h4 className="text-[rgba(153,189,255,1)] text-base md:text-lg font-semibold">
                Download Our App
              </h4>

              <div className="flex flex-col sm:flex-row gap-4 w-full">
                {/* App Store */}
                <button className="flex items-center gap-3 bg-white/10 backdrop-blur-sm px-4 py-2.5 rounded-md hover:bg-white/20 transition w-full sm:w-auto">
                  <img src={vector} alt="App Store" className="w-7 h-7" />
                  <div className="flex flex-col text-left">
                    <p className="text-[10px] text-gray-300">Download in the</p>
          ...
          <div className="grid w-full lg:w-2/3 max-[500px]:grid-cols-1 grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
            {footerSections.map((section, index) => (
              <div key={index} className="flex flex-col">
                <h2 className="text-[rgba(153,189,255,1)] font-semibold text-base mb-2">
                  {section.title}
                </h2>
