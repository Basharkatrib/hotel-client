      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
            {/* Language/Currency */}
            <button
              className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full font-medium text-sm transition-all duration-200 bg-gray-100 text-gray-700 hover:bg-gray-200 border border-gray-200"
            ...
            <button
              type="button"
              className="flex md:hidden items-center justify-center h-10 w-10 rounded-full bg-white/90 text-gray-800 shadow-md"
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-white/95 backdrop-blur-xl text-gray-900 border-t border-gray-200 shadow-2xl"
          >
