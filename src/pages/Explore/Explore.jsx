                ...
                <div className="flex-1 max-w-full">
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-1.5 text-xs sm:text-sm rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-all placeholder:text-gray-400"
                    />
