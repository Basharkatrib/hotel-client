...
const BookingConfirmation = () => {
  ...
  const { hotel, room, checkIn, checkOut, guests, rooms, pricing } =
    location.state || {};
  ...
  const handleSubmit = async (e) => {
    ...
    if (guests > room.max_guests) {
      toast.error(
        `This room can accommodate a maximum of ${room.max_guests} guests. Please reduce the number of guests.`
      );
      setIsLoading(false);
      return;
    }

    const allGuestsValid = guestsInfo.every(
      (guest) => guest.name.trim() && guest.email.trim() && guest.phone.trim()
    );
    ...
    <div className="p-6">
      ...
      <div className="flex gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-blue-600 dark:text-blue-400 font-medium mt-1 uppercase tracking-wider">
            {room.name}
          </p>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 text-center sm:text-left mt-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">
            Please review your booking details and provide guest information.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-white dark:bg-card rounded-2xl shadow-sm overflow-hidden border border-gray-100 dark:border-gray-800 transition-colors duration-300">
              ...
              <div className="bg-white dark:bg-card rounded-2xl shadow-sm p-6 border border-gray-100 dark:border-gray-800 transition-colors duration-300">
                ...
                <div className="mt-4 flex items-start gap-3 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-100 dark:border-amber-900/30">
                  <p className="text-sm text-amber-800 dark:text-amber-400 leading-relaxed">
                    <strong>Note:</strong> Special requests are subject to
                    availability and cannot be guaranteed by the hotel. Some
                    requests may incur additional charges.
                  </p>
                </div>
              </div>
          ...
          <div className="lg:col-span-1">
            {/* Desktop Sidebar */}
            <div className="hidden lg:block bg-white dark:bg-card rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 sticky top-24 transition-colors duration-300">
