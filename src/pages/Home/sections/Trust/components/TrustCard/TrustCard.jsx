      ...
      <div className="text-center px-4 md:px-2">
        ...
        <div className="flex justify-center mb-4 sm:mb-5 md:mb-6">
          <div className="relative">
            <div className="w-20 h-20 sm:w-24 sm:h-24 bg-blue-100 dark:bg-card rounded-2xl flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-300">
              <img
                src={icon}
                alt={title}
