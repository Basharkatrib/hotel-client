          ...
          {categories.map((category) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1 sm:gap-1.5 md:gap-2 px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 md:py-2.5 rounded-lg transition-all text-[9px] sm:text-xs md:text-sm font-medium ${
